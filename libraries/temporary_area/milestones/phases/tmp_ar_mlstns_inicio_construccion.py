...
def tmp_ar_mlstns_inicio_construccion(milestones_dataset, tbl_proyectos, current_bash):
    ...
    auxCol=start_building[start_building['stg_nombre_actividad'] == "Entrega de documentos para elaboración de presupuesto de inicio de construcción"].loc[:,('key','stg_fecha_final_actual','stg_fin_linea_base_estimado', 'stg_fecha_fin_planeada')]
    auxCol['total']=np.where(auxCol['stg_fecha_final_actual'].isna(),auxCol['stg_fecha_fin_planeada'],auxCol['stg_fecha_final_actual'])
    ...
    auxCol=start_building[start_building['stg_nombre_actividad'] == "Diseño para inicio de construcción"].loc[:,('key','stg_fecha_final_actual','stg_fin_linea_base_estimado', 'stg_fecha_fin_planeada')]
    auxCol['total']=np.where(auxCol['stg_fecha_final_actual'].isna(),auxCol['stg_fecha_fin_planeada'],auxCol['stg_fecha_final_actual'])
