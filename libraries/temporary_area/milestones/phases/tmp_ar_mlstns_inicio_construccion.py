...
def tmp_ar_mlstns_inicio_construccion(milestones_dataset, tbl_proyectos):
    ...
    tbl_inicio_construccion=pd.merge(tbl_inicio_construccion, start_building[start_building['stg_nombre_actividad'] == "10.Kit 2 Construcciones"].loc[:,('key','stg_fecha_fin_planeada','stg_fecha_fin')].rename(columns={'stg_fecha_fin':'tic_entrega_kit2_programado', 'stg_fecha_fin_planeada':'tic_entrega_kit2_proyectado'}), on='key', how="outer",)
    tbl_inicio_construccion=pd.merge(tbl_inicio_construccion, start_building[start_building['stg_nombre_actividad'] == "9.Kit 1 Construcciones"].loc[:,('key','stg_fecha_fin_planeada','stg_fecha_fin')].rename(columns={'stg_fecha_fin':'tic_entrega_kit1_programado', 'stg_fecha_fin_planeada':'tic_entrega_kit1_proyectado'}), on='key', how="outer",)
    tbl_inicio_construccion=pd.merge(tbl_inicio_construccion, start_building[start_building['stg_nombre_actividad'] == "8.Aprobacion de FIC en CIP"].loc[:,('key','stg_fecha_fin_planeada','stg_fecha_fin')].rename(columns={'stg_fecha_fin':'tic_factib_inic_constru_programado', 'stg_fecha_fin_planeada':'tic_factib_inic_constru_proyectado'}), on='key', how="outer",)
    tbl_inicio_construccion=pd.merge(tbl_inicio_construccion, start_building[start_building['stg_nombre_actividad'] == "Ppto Definitivo (Tipo FIC)"].loc[:,('key','stg_fecha_fin_planeada','stg_fecha_fin')].rename(columns={'stg_fecha_fin':'tic_ppto_definitivo_programado', 'stg_fecha_fin_planeada':'tic_ppto_definitivo_proyectado'}), on='key', how="outer",)
    tbl_inicio_construccion=pd.merge(tbl_inicio_construccion, start_building[start_building['stg_nombre_actividad'] == "7.Presupuesto SIPRO"].loc[:,('key','stg_fecha_fin_planeada','stg_fecha_fin')].rename(columns={'stg_fecha_fin':'tic_ppto_sipro_programado', 'stg_fecha_fin_planeada':'tic_ppto_sipro_proyectado'}), on='key', how="outer",)
    tbl_inicio_construccion=pd.merge(tbl_inicio_construccion, start_building[start_building['stg_nombre_actividad'] == "Entrega de documentos para elaboración de presupuesto de inicio de construcción"].loc[:,('key','stg_fecha_fin_planeada','stg_fecha_fin')].rename(columns={'stg_fecha_fin':'tic_docs_inic_constru_programado', 'stg_fecha_fin_planeada':'tic_docs_inic_constru_proyectado'}), on='key', how="outer",)
    tbl_inicio_construccion=pd.merge(tbl_inicio_construccion, start_building[start_building['stg_nombre_actividad'] == "Diseño para inicio de construcción"].loc[:,('key','stg_fecha_fin_planeada','stg_fecha_fin')].rename(columns={'stg_fecha_fin':'tic_diseno_inic_constru_programado', 'stg_fecha_fin_planeada':'tic_diseno_inic_constru_proyectado'}), on='key', how="outer",)
