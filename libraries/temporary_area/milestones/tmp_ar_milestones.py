...
def tmp_ar_milestones(stg_consolidado_corte, tbl_proyectos, current_bash):
    ...
    milestones_dataset=stg_consolidado_corte.loc[:, ('stg_codigo_proyecto', 'stg_etapa_proyecto', 'stg_programacion_proyecto', 'stg_duracion_cantidad', 'stg_fecha_fin_planeada', 'stg_ind_buffer', 'stg_fecha_fin','stg_nombre_actividad', 'stg_fecha_corte', 'stg_notas', 'stg_fecha_final_actual')]
