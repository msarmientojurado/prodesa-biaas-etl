...
def tmp_ar_deliveries(stg_consolidado_corte, tbl_proyectos):
    ...
    tbl_reporte_por_entregas=auxCol.loc[:,('key','stg_fecha_fin', 'stg_fecha_fin_planeada')].rename(columns={'stg_fecha_fin':'trpe_entrega_real', 'stg_fecha_fin_planeada':'trpe_entrega_programada'})
