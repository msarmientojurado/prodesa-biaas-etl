...
def tmp_ar_building(stg_consolidado_corte, tbl_proyectos, current_bash):
    ...
    # registers which have the word `CS` in their `stg_area_prodesa` column
    ...
    #Customer request: 'tpc_avance_cc' column values cannot be negative. Negative values should be mapped to zero 
    ...
    #Customer request: 'tpc_consumo_buffer' column values cannot be negative. Negative values should be mapped to zero 
    tmp_proyectos_construccion['tpc_consumo_buffer']=np.where(tmp_proyectos_construccion['tpc_consumo_buffer']<0,0,tmp_proyectos_construccion['tpc_consumo_buffer'])
    ...
    #Columns `tpc_regional`, `tpc_macroproyecto`, `tpc_proyecto`
    ...
    #Customer request: 'tpc_ultimo_mes' column values cannot be negative. Negative values should be mapped to zero 
    tmp_proyectos_construccion['tpc_ultimo_mes']=np.where(tmp_proyectos_construccion['tpc_ultimo_mes']<0,0,tmp_proyectos_construccion['tpc_ultimo_mes'])
    ...
    tmp_proyectos_construccion['tpc_ultima_semana']=np.where(tmp_proyectos_construccion['tpc_ultima_semana']<0,0,tmp_proyectos_construccion['tpc_ultima_semana'])
    ...
    #Column tpc_fecha_proceso
    tmp_proyectos_construccion['tpc_fecha_proceso']=date.today()
