...
def mdl_ar_mlstns_inicio_construccion(tmp_proyectos_construccion):
    print("  *Model -tmp_proyectos_construccion- Starting")
    ...
    job.result()
    print("  -Model -tmp_proyectos_construccion- ending")
